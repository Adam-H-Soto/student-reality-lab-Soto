        ...
        <div className="mx-auto max-w-7xl px-5 py-16">
          ...
          <div className="mb-10 max-w-3xl">
            ...
            <p className="text-[16px] leading-6 text-slate-600">
              Explore how affordability and food insecurity connect. Feel free to jump between points and compare regions.
            </p>
            <p className="mt-2 text-sm text-[#76828a]">People across the community use this view to understand where support may be needed most.</p>
          </div>

          {loading && <p className="text-[16px] text-slate-600">Loading analysis data...</p>}
